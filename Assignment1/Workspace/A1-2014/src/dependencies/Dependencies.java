...
public class Dependencies {
    ...
    /**
     * Merge the dependencies from one dependency list with the dependencies
     * of the current list. This also accounts for transitive dependencies and
     * allows for successful processing of the select statement
     * 
     * @param other - A dependency list
     */
    public void mergeDependencies(Dependencies other) {
    	for (String S : other.dependencies.keySet()) {
        	...
        	// If there are no transitive dependencies, just add the
        	// dependencies as is.
